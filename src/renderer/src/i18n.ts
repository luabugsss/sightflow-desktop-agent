...
const translations = {
  zh: {
    ...
    // Settings
    'settings.vision': '视觉定位配置',
    'settings.appType': '应用类型',
    'settings.visionApiKey': '视觉定位 API Key',
    'settings.visionApiKey.placeholder': '输入当前视觉模型的 API Key',
    'settings.visionApiKey.hint': '用于布局分析、未读检测和界面定位；可以选择火山方舟或 MiniMax，并填写具体模型名称。',
    'settings.visionPreset': '视觉模型预设',
    'settings.visionPreset.custom': '自定义',
    'settings.visionModel': '视觉定位模型',
    'settings.visionBaseUrl': '视觉定位服务地址',
  ...
  en: {
    ...
    'settings.vision': 'Vision Grounding',
    'settings.appType': 'App Type',
    'settings.visionApiKey': 'Vision API Key',
    'settings.visionApiKey.placeholder': 'Enter the API Key for the selected vision model',
    'settings.visionApiKey.hint': 'Used for layout analysis, unread detection, and UI grounding. Volcengine Ark and MiniMax are both selectable; set the concrete model name below.',
    'settings.visionPreset': 'Vision Model Preset',
    'settings.visionPreset.custom': 'Custom',
    'settings.visionModel': 'Vision Grounding Model',
    'settings.visionBaseUrl': 'Vision Grounding Base URL',
