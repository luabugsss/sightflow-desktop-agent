...
const translations = {
  zh: {
    ...
    'settings.visionApiKey.hint': '用于布局分析、未读检测和界面定位；可以选择火山方舟或 MiniMax M3。',
  ...
  en: {
    ...
    'settings.visionApiKey.hint': 'Used for layout analysis, unread detection, and UI grounding. Volcengine Ark and MiniMax M3 are both selectable.',
